...
export const inspectionPlans = [
    ...
    { id: 2, type: INSPECTION_PLAN.basica, title: "Inspección Básica", description: "Revisión general del vehículo", landingDescription: "Verifica lo esencial antes de firmar. Mecánica, estética y legal.", price: 249, classType: "middle" },
    { id: 3, type: INSPECTION_PLAN.completa, title: "Inspección Premium", description: "Revisión técnica y legal", landingDescription: "La verificación más completa y detallada del mercado que incluye videoscopía y asesoría.", price: 299, classType: "last" },
]
...
export const inspectionPlanItems = [
    ...
    { inspectionPlanId: 3, label: ["Toda la inspección básica", "Videoscopía completa del motor y zonas críticas", "Asesoría en presupuesto de reparación", "Informe técnico y legal documentado"] }
]